...
| Path predicates (key-based refs) — a `[key=value]` segment in a ref's pointer selecting the array element whose field equals the value. A predicate ref is valid while the key resolves; an index ref is valid while the partition's generation holds. Used when the observed data offers a stable key, never required of vendors                                                                                                                                                                                                                        | upstream candidate                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
