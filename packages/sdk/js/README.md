...
The TypeScript projection of the A2UIVerse app contract: the composition extension (SPEC §14) — extension URI, composition stamp, slot request, surface-id namespacing — with the app manifest to follow in Phase 10. The normative definition is [`../contracts`](../contracts); `src/composition.contract.test.ts` asserts this projection against it — drift is a red build.
