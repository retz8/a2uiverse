/**
 * LEGACY — the Phase 4 synthesis wiring (contract v0.2), kept so the
 * orchestrator and client compile until 5.4 and 5.5 switch to `synthesis.ts`;
 * removed with them, together with `composition.v0.2.json`. The
