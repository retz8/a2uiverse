...
- [ ] **6.1** Doc edits — SPEC §4.4 (archetypes), §5 (the turn: the Planner's readers and tree), §8 (the gap as a slot the Planner places), §10 (the Planner's row, "never sees data" resolved as never vendor data), §12 M3s line
