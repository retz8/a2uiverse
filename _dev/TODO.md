...
- [ ] **5.8** Design records — `synthesis.md` rewritten, Synthesizer sections of the orchestrator and client records; `packages/sdk` README rewritten — what the sdk exposes, stated plainly and readable without prior knowledge of the synthesize data model (after 5.7)
