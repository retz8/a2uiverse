...
- [WIP] **5.2** `sdk` — composition contract v0.3: the synthesize data model (tree, formula-leaf model, predicate refs, sorts, note), the JS projection, contract tests, published (after 5.1; parallel with 5.3, 5.6)
