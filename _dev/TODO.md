...
- [WIP] **3.3** `[apps]` Stratum-2 skeletons — toolset-wrapper base class, MCP-wiring + tool-shaping skeletons/hooks in the kit; vendor policy bodies rehomed onto them (after 3.2; parallel with 3.4)
