...
- [WIP] **3.1** Doc edits — SPEC §13 dependency-rule amendment + stale `@a2uiverse/sdk` catalog-half claim reconciled, §14 `paintMeta` delta row, one-provider-and-CSS-setup-per-catalog-bundle review rule (#1)
