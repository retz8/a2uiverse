...
- [WIP] **5.11** `sdk` — the Synthesizer's worked examples rewritten against task 5.6's recorded shapes: heterogeneous kinds, opaque ids, a source whose time is not ISO (after 5.6 and 5.10; before 5.7)
