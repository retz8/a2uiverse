...
- [WIP] **5.3** `shell-catalog` — `SortControl` over a sort declaration, catalog schema and operator descriptions exported for the Synthesizer's prompt, `DerivedValue` untouched (after 5.1; parallel with 5.2, 5.6)
