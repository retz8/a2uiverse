...
4. **Appear, live**: rerunning a build inside the CircleCI fragment makes a new run appear; the walk fires re-synthesis with an appeared entry; the row re-points to the new run.
