...
`github/manifest.json` mirrors the orchestrator's registry record (id, display name, agent URL, auth, catalog id, catalog package) and notes that the schema lands with the `sdk` manifest in Phase 11. Nothing reads it in Phase 1.
