...
Hardcoded until M7 (`src/registry/entries.ts`): `github` → `http://localhost:11001`. Run the GitHub app's agent (`../a2uiverse-apps/github/agent`, port 11001 by default) in the mode you want:
