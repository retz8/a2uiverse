...
export interface PlanRecord {
  ...
  /** The composition's title as emitted (task-9.3 decision 4), and whether the Planner's was clipped to the cap. */
  title?: string;
  titleClipped?: true;
  /** The composition this one was asked from, when the utterance named one the session holds. */
  parent?: string;
...
export interface JournalEntry {
  ...
  /** The user closed the composition while this turn ran (task-9.3 decision 5). */
  closed?: true;
